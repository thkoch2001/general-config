...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tramp-cache" '("tramp-" "with-tramp-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tramp-container" '("tramp-")))
